...
export const ProductDetailModal: React.FC<ProductDetailModalProps> = ({
  ...
  return (
    <>
                    ...
                    <div className="grid grid-cols-2 lg:grid-cols-4 gap-2">
                      {relatedProducts.map((relatedProduct) => (
                        <div 
                          ...
                          className="bg-white rounded-lg border p-2 hover:shadow-md transition-shadow cursor-pointer hover:scale-105 transition-all duration-300"
      ...
      {/* Modal para Produto Relacionado */}
