        ...
        <div className="bg-white rounded-xl shadow-md hover:shadow-lg transition-all duration-300 p-4 cursor-pointer" onClick={handleCardClick}>
          <div className="flex gap-4">
            ...
            <div className="w-20 h-24 sm:w-24 sm:h-28 flex-shrink-0 rounded-lg overflow-hidden bg-gradient-to-br from-blue-50 to-purple-50">
              <LazyImage src={product.imagem1} alt={product.produto} className="w-full h-full object-contain" />
            </div>
            ...
            <div className="flex-1 min-w-0 flex flex-col justify-between">
              ...
              <div className="flex items-center justify-between gap-4">
                ...
                <div className="flex items-center gap-2 flex-shrink-0">
                  <FavoriteButton productId={product.id} size="sm" showText={false} className="min-w-[40px] h-9" />
                  <Button size="sm" onClick={handleVerMaisClick} className="bg-blue-600 hover:bg-blue-700 text-white font-semibold text-xs px-3 py-2 h-9 min-w-[80px] whitespace-nowrap">
                    Ver detalhes
                  </Button>
                  <Button size="sm" onClick={handleBuyClick} className="bg-green-600 hover:bg-green-700 text-white font-bold text-xs px-3 py-2 h-9 min-w-[44px] flex items-center justify-center">
  ...
  return <>
      <Card id={`product-${product.id}`} style={style} className={`
        ...
        <div className="relative h-48 flex-shrink-0">
          ...
          {!showBadge && !selectable && <div className="absolute top-2 right-2">
        ...
        <CardContent className="p-3 flex flex-col justify-between flex-1 min-h-[128px] py-0 px-[10px] my-0 mx-0">
          ...
          <div className="space-y-2 mt-auto">
            ...
            {(showBadge || selectable) && <div className="flex gap-1 mb-2">
                <FavoriteButton productId={product.id} />
              </div>}
            
            <Button size="sm" variant="outline" className="w-full bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white font-bold shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105 border-0 btn-responsive" onClick={handleVerMaisClick}>
